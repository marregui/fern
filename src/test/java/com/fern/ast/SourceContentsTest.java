...
public class SourceContentsTest {
  @Test
  public void readFile() throws Exception {
    ...
    final SourceContents reader = SourceContents.fromFile(fileName);
    final String contentsFromReader = reader.getContents();
  ...
  private static final void checkLineNumberForFileOffset(SourceContents reader, int offset, int expectedLine) {
    assertTrue(expectedLine == reader.lineNumberFor(offset));
  }

  private static final void checkCharOffsetInLine(SourceContents reader, int offset, int expectedLine, int expectedOffset) {
    assertTrue(expectedLine == reader.lineNumberFor(offset));
